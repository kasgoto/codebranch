...
const Team = () => {
  return (
    <section
      id='team'
      className='mx-auto max-w-screen-2xl container px-[60px] bg-[#f6f6f6] rounded-[25px] md:mt-[145px] mt-[80px] md:pt-[50px] pt-[30px] md:pb-[140px] pb-[70px] text-black text-center'
    >
